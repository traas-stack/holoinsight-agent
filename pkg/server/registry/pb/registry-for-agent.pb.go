...
func (x *MetaSync_FullSyncRequest) Reset() {
	*x = MetaSync_FullSyncRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_registry_for_agent_proto_msgTypes[36]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_registry_for_agent_proto_rawDesc = []byte{
	...
	0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x14,
	0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76,
	0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x32, 0xda, 0x0a, 0x0a, 0x17, 0x52, 0x65, 0x67,
	...
	,
...
var file_registry_for_agent_proto_msgTypes = make([]protoimpl.MessageInfo, 42)
var file_registry_for_agent_proto_goTypes = []interface{}{
	...
	nil,                                     // 27: io.holoinsight.server.registry.grpc.agent.CollectTarget.MetaEntry
	nil,                                     // 28: io.holoinsight.server.registry.grpc.agent.Agent.OtherEntry
	nil,                                     // 29: io.holoinsight.server.registry.grpc.agent.RegisterAgentRequest.LabelsEntry
	nil,                                     // 30: io.holoinsight.server.registry.grpc.agent.GetCollectTasksRequest.BucketsEntry
	nil,                                     // 31: io.holoinsight.server.registry.grpc.agent.GetCollectTasksResponse.BucketsEntry
	nil,                                     // 32: io.holoinsight.server.registry.grpc.agent.GetCollectTasksResponse.CollectConfigsEntry
	nil,                                     // 33: io.holoinsight.server.registry.grpc.agent.GetCollectTasksResponse.CollectTargetsEntry
	nil,                                     // 34: io.holoinsight.server.registry.grpc.agent.RunStatsRequest.AgentRunStatsEntry
	nil,                                     // 35: io.holoinsight.server.registry.grpc.agent.CollectConfigRunStats.StatsEntry
	(*MetaSync_FullSyncRequest)(nil),        // 36: io.holoinsight.server.registry.grpc.agent.MetaSync.FullSyncRequest
	(*MetaSync_DeltaSyncRequest)(nil),       // 37: io.holoinsight.server.registry.grpc.agent.MetaSync.DeltaSyncRequest
	(*MetaSync_Resource)(nil),               // 38: io.holoinsight.server.registry.grpc.agent.MetaSync.Resource
	nil,                                     // 39: io.holoinsight.server.registry.grpc.agent.MetaSync.Resource.LabelsEntry
	nil,                                     // 40: io.holoinsight.server.registry.grpc.agent.MetaSync.Resource.AnnotationsEntry
	nil,                                     // 41: io.holoinsight.server.registry.grpc.agent.MetaSync.Resource.SpecEntry
	(*pb.CommonRequestHeader)(nil),          // 42: io.holoinsight.server.common.grpc.CommonRequestHeader
	(*pb.CommonResponseHeader)(nil),         // 43: io.holoinsight.server.common.grpc.CommonResponseHeader
	(*emptypb.Empty)(nil),                   // 44: google.protobuf.Empty
	(*pb.GenericRpcCommand)(nil),            // 45: io.holoinsight.server.common.grpc.GenericRpcCommand
}
var file_registry_for_agent_proto_depIdxs = []int32{
	...
	27, // 2: io.holoinsight.server.registry.grpc.agent.CollectTarget.meta:type_name -> io.holoinsight.server.registry.grpc.agent.CollectTarget.MetaEntry
	...
	28, // 4: io.holoinsight.server.registry.grpc.agent.Agent.other:type_name -> io.holoinsight.server.registry.grpc.agent.Agent.OtherEntry
	42, // 5: io.holoinsight.server.registry.grpc.agent.RegisterAgentRequest.header:type_name -> io.holoinsight.server.common.grpc.CommonRequestHeader
	29, // 6: io.holoinsight.server.registry.grpc.agent.RegisterAgentRequest.labels:type_name -> io.holoinsight.server.registry.grpc.agent.RegisterAgentRequest.LabelsEntry
	...
	43, // 8: io.holoinsight.server.registry.grpc.agent.RegisterAgentResponse.header:type_name -> io.holoinsight.server.common.grpc.CommonResponseHeader
	42, // 9: io.holoinsight.server.registry.grpc.agent.SendAgentHeartbeatRequest.header:type_name -> io.holoinsight.server.common.grpc.CommonRequestHeader
	43, // 10: io.holoinsight.server.registry.grpc.agent.SendAgentHeartbeatResponse.header:type_name -> io.holoinsight.server.common.grpc.CommonResponseHeader
	42, // 11: io.holoinsight.server.registry.grpc.agent.GetControlConfigsRequest.header:type_name -> io.holoinsight.server.common.grpc.CommonRequestHeader
	43, // 12: io.holoinsight.server.registry.grpc.agent.GetControlConfigsResponse.header:type_name -> io.holoinsight.server.common.grpc.CommonResponseHeader
	...
	42, // 15: io.holoinsight.server.registry.grpc.agent.GetCollectTasksRequest.header:type_name -> io.holoinsight.server.common.grpc.CommonRequestHeader
	30, // 16: io.holoinsight.server.registry.grpc.agent.GetCollectTasksRequest.buckets:type_name -> io.holoinsight.server.registry.grpc.agent.GetCollectTasksRequest.BucketsEntry
	43, // 17: io.holoinsight.server.registry.grpc.agent.GetCollectTasksResponse.header:type_name -> io.holoinsight.server.common.grpc.CommonResponseHeader
	31, // 18: io.holoinsight.server.registry.grpc.agent.GetCollectTasksResponse.buckets:type_name -> io.holoinsight.server.registry.grpc.agent.GetCollectTasksResponse.BucketsEntry
	32, // 19: io.holoinsight.server.registry.grpc.agent.GetCollectTasksResponse.collect_configs:type_name -> io.holoinsight.server.registry.grpc.agent.GetCollectTasksResponse.CollectConfigsEntry
	33, // 20: io.holoinsight.server.registry.grpc.agent.GetCollectTasksResponse.collect_targets:type_name -> io.holoinsight.server.registry.grpc.agent.GetCollectTasksResponse.CollectTargetsEntry
	42, // 21: io.holoinsight.server.registry.grpc.agent.RunStatsRequest.header:type_name -> io.holoinsight.server.common.grpc.CommonRequestHeader
	34, // 22: io.holoinsight.server.registry.grpc.agent.RunStatsRequest.agent_run_stats:type_name -> io.holoinsight.server.registry.grpc.agent.RunStatsRequest.AgentRunStatsEntry
	...
	35, // 24: io.holoinsight.server.registry.grpc.agent.CollectConfigRunStats.stats:type_name -> io.holoinsight.server.registry.grpc.agent.CollectConfigRunStats.StatsEntry
	42, // 25: io.holoinsight.server.registry.grpc.agent.RunStatsResponse.header:type_name -> io.holoinsight.server.common.grpc.CommonRequestHeader
	42, // 26: io.holoinsight.server.registry.grpc.agent.RunEventsRequest.header:type_name -> io.holoinsight.server.common.grpc.CommonRequestHeader
	...
	42, // 28: io.holoinsight.server.registry.grpc.agent.RunEventsResponse.header:type_name -> io.holoinsight.server.common.grpc.CommonRequestHeader
	43, // 29: io.holoinsight.server.registry.grpc.agent.BiStreamClientHandshakeResponse.header:type_name -> io.holoinsight.server.common.grpc.CommonResponseHeader
	4,  // 30: io.holoinsight.server.registry.grpc.agent.GetCollectTasksResponse.BucketsEntry.value:type_name -> io.holoinsight.server.registry.grpc.agent.CollectConfigsBucket
	2,  // 31: io.holoinsight.server.registry.grpc.agent.GetCollectTasksResponse.CollectConfigsEntry.value:type_name -> io.holoinsight.server.registry.grpc.agent.CollectConfig
	3,  // 32: io.holoinsight.server.registry.grpc.agent.GetCollectTasksResponse.CollectTargetsEntry.value:type_name -> io.holoinsight.server.registry.grpc.agent.CollectTarget
	42, // 33: io.holoinsight.server.registry.grpc.agent.MetaSync.FullSyncRequest.header:type_name -> io.holoinsight.server.common.grpc.CommonRequestHeader
	38, // 34: io.holoinsight.server.registry.grpc.agent.MetaSync.FullSyncRequest.resource:type_name -> io.holoinsight.server.registry.grpc.agent.MetaSync.Resource
	42, // 35: io.holoinsight.server.registry.grpc.agent.MetaSync.DeltaSyncRequest.header:type_name -> io.holoinsight.server.common.grpc.CommonRequestHeader
	38, // 36: io.holoinsight.server.registry.grpc.agent.MetaSync.DeltaSyncRequest.add:type_name -> io.holoinsight.server.registry.grpc.agent.MetaSync.Resource
	38, // 37: io.holoinsight.server.registry.grpc.agent.MetaSync.DeltaSyncRequest.del:type_name -> io.holoinsight.server.registry.grpc.agent.MetaSync.Resource
	39, // 38: io.holoinsight.server.registry.grpc.agent.MetaSync.Resource.labels:type_name -> io.holoinsight.server.registry.grpc.agent.MetaSync.Resource.LabelsEntry
	40, // 39: io.holoinsight.server.registry.grpc.agent.MetaSync.Resource.annotations:type_name -> io.holoinsight.server.registry.grpc.agent.MetaSync.Resource.AnnotationsEntry
	41, // 40: io.holoinsight.server.registry.grpc.agent.MetaSync.Resource.spec:type_name -> io.holoinsight.server.registry.grpc.agent.MetaSync.Resource.SpecEntry
	44, // 41: io.holoinsight.server.registry.grpc.agent.RegistryServiceForAgent.ping:input_type -> google.protobuf.Empty
	7,  // 42: io.holoinsight.server.registry.grpc.agent.RegistryServiceForAgent.register_agent:input_type -> io.holoinsight.server.registry.grpc.agent.RegisterAgentRequest
	10, // 43: io.holoinsight.server.registry.grpc.agent.RegistryServiceForAgent.send_agent_heartbeat:input_type -> io.holoinsight.server.registry.grpc.agent.SendAgentHeartbeatRequest
	18, // 44: io.holoinsight.server.registry.grpc.agent.RegistryServiceForAgent.send_run_stats:input_type -> io.holoinsight.server.registry.grpc.agent.RunStatsRequest
	21, // 45: io.holoinsight.server.registry.grpc.agent.RegistryServiceForAgent.send_run_events:input_type -> io.holoinsight.server.registry.grpc.agent.RunEventsRequest
	12, // 46: io.holoinsight.server.registry.grpc.agent.RegistryServiceForAgent.get_control_configs:input_type -> io.holoinsight.server.registry.grpc.agent.GetControlConfigsRequest
	16, // 47: io.holoinsight.server.registry.grpc.agent.RegistryServiceForAgent.get_collect_tasks:input_type -> io.holoinsight.server.registry.grpc.agent.GetCollectTasksRequest
	45, // 48: io.holoinsight.server.registry.grpc.agent.RegistryServiceForAgent.bi_streams:input_type -> io.holoinsight.server.common.grpc.GenericRpcCommand
	36, // 49: io.holoinsight.server.registry.grpc.agent.RegistryServiceForAgent.meta_full_sync:input_type -> io.holoinsight.server.registry.grpc.agent.MetaSync.FullSyncRequest
	37, // 50: io.holoinsight.server.registry.grpc.agent.RegistryServiceForAgent.meta_delta_sync:input_type -> io.holoinsight.server.registry.grpc.agent.MetaSync.DeltaSyncRequest
	44, // 51: io.holoinsight.server.registry.grpc.agent.RegistryServiceForAgent.ping:output_type -> google.protobuf.Empty
	9,  // 52: io.holoinsight.server.registry.grpc.agent.RegistryServiceForAgent.register_agent:output_type -> io.holoinsight.server.registry.grpc.agent.RegisterAgentResponse
	11, // 53: io.holoinsight.server.registry.grpc.agent.RegistryServiceForAgent.send_agent_heartbeat:output_type -> io.holoinsight.server.registry.grpc.agent.SendAgentHeartbeatResponse
	20, // 54: io.holoinsight.server.registry.grpc.agent.RegistryServiceForAgent.send_run_stats:output_type -> io.holoinsight.server.registry.grpc.agent.RunStatsResponse
	23, // 55: io.holoinsight.server.registry.grpc.agent.RegistryServiceForAgent.send_run_events:output_type -> io.holoinsight.server.registry.grpc.agent.RunEventsResponse
	13, // 56: io.holoinsight.server.registry.grpc.agent.RegistryServiceForAgent.get_control_configs:output_type -> io.holoinsight.server.registry.grpc.agent.GetControlConfigsResponse
	17, // 57: io.holoinsight.server.registry.grpc.agent.RegistryServiceForAgent.get_collect_tasks:output_type -> io.holoinsight.server.registry.grpc.agent.GetCollectTasksResponse
	45, // 58: io.holoinsight.server.registry.grpc.agent.RegistryServiceForAgent.bi_streams:output_type -> io.holoinsight.server.common.grpc.GenericRpcCommand
	44, // 59: io.holoinsight.server.registry.grpc.agent.RegistryServiceForAgent.meta_full_sync:output_type -> google.protobuf.Empty
	44, // 60: io.holoinsight.server.registry.grpc.agent.RegistryServiceForAgent.meta_delta_sync:output_type -> google.protobuf.Empty
...
func file_registry_for_agent_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_registry_for_agent_proto_msgTypes[36].Exporter = func(v interface{}, i int) interface{} {
